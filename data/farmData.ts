...
export const PRODUCTS: Product[] = [
    ...
    { id: 'popcorn', name: 'Bắp Rang Bơ', emoji: '🍿', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 130 },
    ...
    { id: 'veggie_skewer', name: 'Xiên Rau Củ', emoji: '🍡', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 320 },
    ...
    { id: 'milk', name: 'Sữa tươi', emoji: '🥛', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 130 },
    ...
    { id: 'goat_milk', name: 'Sữa dê', emoji: '🥛', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 190 },
    ...
    { id: 'buffalo_milk', name: 'Sữa trâu', emoji: '🥛', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 220 },
    ...
    { id: 'quail_egg', name: 'Trứng cút', emoji: '🥚', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 55 },
    { id: 'turkey_meat', name: 'Thịt gà tây', emoji: '🍖', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 250 },
    { id: 'horse_hair', name: 'Lông ngựa', emoji: '🐎', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 850 },
    ...
    { id: 'peacock_feather', name: 'Lông công', emoji: '🪶', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 700 },
    ...
    { id: 'bone', name: 'Xương', emoji: '🦴', type: 'PRODUCT', currency: 'COIN', cost: 0, sellPrice: 300 },
    ...
    { id: 'bread', name: 'Bánh mì', emoji: '🍞', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 130 },
    ...
    { id: 'croissant', name: 'Bánh sừng bò', emoji: '🥐', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 480 },
    { id: 'pancake', name: 'Bánh kếp', emoji: '🥞', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 320 },
    ...
    { id: 'sandwich', name: 'Sandwich', emoji: '🥪', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 1100 },
    { id: 'butter', name: 'Bơ', emoji: '🧈', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 300 },
    { id: 'cheese', name: 'Phô mai', emoji: '🧀', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 450 },
    { id: 'cream', name: 'Kem tươi', emoji: '🍦', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 200 },
    { id: 'flour', name: 'Bột mì', emoji: '🥡', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 80 },
    { id: 'sugar', name: 'Đường', emoji: '🧂', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 110 },
    { id: 'syrup', name: 'Xi-rô', emoji: '🍯', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 220 },
    { id: 'yogurt', name: 'Sữa chua', emoji: '🥣', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 280 },
    { id: 'ice_cream', name: 'Kem ly', emoji: '🍨', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 550 },
    { id: 'chocolate', name: 'Sô cô la', emoji: '🍫', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 750 },
    { id: 'candy', name: 'Kẹo', emoji: '🍬', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 420 },
    { id: 'apple_juice', name: 'Nước táo', emoji: '🧃', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 850 },
    { id: 'orange_juice', name: 'Nước cam', emoji: '🍹', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 750 },
    { id: 'grape_juice', name: 'Nước nho', emoji: '🍷', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 1000 },
    { id: 'carrot_juice', name: 'Nước cà rốt', emoji: '🥤', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 160 },
    { id: 'tomato_juice', name: 'Nước cà chua', emoji: '🥤', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 350 },
    { id: 'coffee', name: 'Cà phê', emoji: '☕', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 650 },
    { id: 'tea', name: 'Trà', emoji: '🍵', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 500 },
    { id: 'green_smoothie', name: 'Sinh tố xanh', emoji: '🥤', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 400 },
    { id: 'strawberry_milk', name: 'Sữa dâu', emoji: '🧋', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 520 },
    { id: 'sushi', name: 'Sushi', emoji: '🍣', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 250 },
    { id: 'bouquet', name: 'Bó Hoa', emoji: '💐', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 1000 },
    { id: 'sunflower_bouquet', name: 'Bó Hướng Dương', emoji: '🌻', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 200 },
    { id: 'perfume', name: 'Nước Hoa Hồng', emoji: '🌹', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 1800 },
    { id: 'floral_scent', name: 'Hương Hoa', emoji: '🌷', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 350 },
    { id: 'cotton_fabric', name: 'Vải Cotton', emoji: '👕', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 550 },
    ...
    { id: 'fruit_salad', name: 'Salad Trái Cây', emoji: '🍎', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 850 },
    ...
    { id: 'ketchup', name: 'Tương Cà', emoji: '🥫', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 450 },
    { id: 'chili_sauce', name: 'Tương Ớt', emoji: '🌶️', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 480 },
    { id: 'soy_sauce', name: 'Nước Tương', emoji: '🍶', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 300 },
    { id: 'peanut_butter', name: 'Bơ Đậu Phộng', emoji: '🥜', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 380 },
    { id: 'spaghetti', name: 'Mì Ý Sốt', emoji: '🍝', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 450 },
    { id: 'lasagna', name: 'Mì Lasagna', emoji: '🥘', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 550 },
    { id: 'spicy_noodle', name: 'Mì Hải Sản Cay', emoji: '🍜', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 600 },
    { id: 'mint_tea', name: 'Trà Bạc Hà', emoji: '🍵', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 280 },
    { id: 'lotus_tea', name: 'Trà Sen', emoji: '🪷', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 350 },
    { id: 'vanilla_ice_cream', name: 'Kem Vani', emoji: '🍦', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 850 },
    { id: 'pearl_necklace', name: 'Vòng Ngọc Trai', emoji: '📿', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 4800 },
    { id: 'flower_ring', name: 'Nhẫn Hoa', emoji: '💍', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 900 },
    { id: 'pho', name: 'Phở Bò', emoji: '🍜', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 650 },
    { id: 'rubber_ball', name: 'Bóng Cao Su', emoji: '⚽', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 400 },
    { id: 'teddy_bear', name: 'Gấu Bông', emoji: '🧸', type: 'PROCESSED', currency: 'COIN', cost: 0, sellPrice: 1400 },
];
